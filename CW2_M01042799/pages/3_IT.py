...
from app.services.ticket_service import (
    fetch_tickets,#Get all tickets
    count_by_priority,#count tickets by priority
    count_by_status,#count tickets by status
    performance_by_staff,#resolution by staff
    trend_over_time,#Ticket trend over time
    ticket_summary,#Text summary
    delete_ticket,
)
...
# Trend over time
st.markdown("###  Ticket Trend Over Time (Scatter + Line)")
